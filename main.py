...
while True:
    ...
    if scores[0] == 3 or scores[1] == 3:
        winner_text = "AI wins!" if scores[0] == 3 else "Player wins!"
        cv2.putText(imgBG, winner_text, (600, 300), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 4)
        cv2.imshow('BG', imgBG)
        cv2.waitKey(3000)  # Wait for 3 seconds after displaying the winner
        break  # Exit the game loop after displaying the winner
